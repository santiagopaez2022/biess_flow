...
public class DatosBean implements Serializable {
	...
	/**
	 * Variable creada para producto viaje Ecuador req-131
	 */
	private boolean prodViajaEcu;
	...
	// CREDITO PAPA
	// Bandera que indica si el producto de biess mujer esta vigente
	private boolean productoBiessPapaVigente;
	private boolean productoBiessPapaSeleccionado;
	//PQ DINAMICO
	private DataRespGenericaResponseDto dataRespGenericaResponseDto;
	private DataProductoDinResponseDto dataProductoDinamico;
	private Long codigoProdEspecial;
	private String codigoContratoProv;
	//REQ-267: Mapa generico que almacena parametros generales
	private Map<String, String> mapaParametrosGenerales;

        private String paginaOrigen;
        
        //MIGRACION CARTERA
    private Precalificacion precalificacion;
    private boolean procesoConciliacionMig;
    private List<Prestamo> prestamosNovacion;
    private List<Prestamo> creditosNoCalificadosNovacion;
    private PrestamoDataProvider prestamoDataProvider;
    private boolean bloqueoNovaPlanillaje;
    
    //Cartera vencida
    private boolean tieneCreditoCastigado;
    
    /**
     * Informacion de garantias SAC
     */
    private InformacionGarantias informacionGarantia;  
    
    /**
     * informacion credito exigible
     */
    private InformacionPQExigible infoPqExigile;
    
    /**
     * Para simulacion guarda
     */
	...
	public boolean isProductoBiessPapaVigente() {
		return productoBiessPapaVigente;
	}

	public void setProductoBiessPapaVigente(boolean productoBiessPapaVigente) {
		this.productoBiessPapaVigente = productoBiessPapaVigente;
	}

	public boolean isProductoBiessPapaSeleccionado() {
		return productoBiessPapaSeleccionado;
	}

	public void setProductoBiessPapaSeleccionado(
			boolean productoBiessPapaSeleccionado) {
		this.productoBiessPapaSeleccionado = productoBiessPapaSeleccionado;
	}

	public boolean isProdViajaEcu() {
		return prodViajaEcu;
	}

	public void setProdViajaEcu(final boolean prodViajaEcu) {
		this.prodViajaEcu = prodViajaEcu;
	}

	public DataRespGenericaResponseDto getDataRespGenericaResponseDto() {
		return dataRespGenericaResponseDto;
	}

	public void setDataRespGenericaResponseDto(DataRespGenericaResponseDto dataRespGenericaResponseDto) {
		this.dataRespGenericaResponseDto = dataRespGenericaResponseDto;
	}

	public DataProductoDinResponseDto getDataProductoDinamico() {
		return dataProductoDinamico;
	}

	public void setDataProductoDinamico(DataProductoDinResponseDto dataProductoDinamico) {
		this.dataProductoDinamico = dataProductoDinamico;
	}

	public Long getCodigoProdEspecial() {
		return codigoProdEspecial;
	}

	public void setCodigoProdEspecial(Long codigoProdEspecial) {
		this.codigoProdEspecial = codigoProdEspecial;
	}

	public String getCodigoContratoProv() {
		return codigoContratoProv;
	}

	public void setCodigoContratoProv(String codigoContratoProv) {
		this.codigoContratoProv = codigoContratoProv;
	}

	public Map<String, String> getMapaParametrosGenerales() {
		return mapaParametrosGenerales;
	}

	public void setMapaParametrosGenerales(Map<String, String> mapaParametrosGenerales) {
		this.mapaParametrosGenerales = mapaParametrosGenerales;
	}
	...
	public boolean isProcesoConciliacionMig() {
		return procesoConciliacionMig;
	}

	public void setProcesoConciliacionMig(boolean procesoConciliacionMig) {
		this.procesoConciliacionMig = procesoConciliacionMig;
	}

	public List<Prestamo> getPrestamosNovacion() {
		return prestamosNovacion;
	}

	public void setPrestamosNovacion(List<Prestamo> prestamosNovacion) {
		this.prestamosNovacion = prestamosNovacion;
	}
	...
	public void setCreditosNoCalificadosNovacion(List<Prestamo> creditosNoCalificadosNovacion) {
		this.creditosNoCalificadosNovacion = creditosNoCalificadosNovacion;
	}

	public PrestamoDataProvider getPrestamoDataProvider() {
		return prestamoDataProvider;
	}

	public void setPrestamoDataProvider(PrestamoDataProvider prestamoDataProvider) {
		this.prestamoDataProvider = prestamoDataProvider;
	}

	public boolean isBloqueoNovaPlanillaje() {
		return bloqueoNovaPlanillaje;
	}

	public void setBloqueoNovaPlanillaje(boolean bloqueoNovaPlanillaje) {
		this.bloqueoNovaPlanillaje = bloqueoNovaPlanillaje;
	}
	...
	public void setInfoPqExigile(InformacionPQExigible infoPqExigile) {
		this.infoPqExigile = infoPqExigile;
	}

	public InformacionGarantias getInformacionGarantia() {
		return informacionGarantia;
	}

	public void setInformacionGarantia(InformacionGarantias informacionGarantia) {
		this.informacionGarantia = informacionGarantia;
	}

	public boolean isTieneCreditoCastigado() {
		return tieneCreditoCastigado;
	}

	public void setTieneCreditoCastigado(boolean tieneCreditoCastigado) {
		this.tieneCreditoCastigado = tieneCreditoCastigado;
	}
