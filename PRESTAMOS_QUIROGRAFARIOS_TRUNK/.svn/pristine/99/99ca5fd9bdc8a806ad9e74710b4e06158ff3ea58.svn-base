 ...
 */
@Remote
public interface ComprobantePagoServicioRemote {

	ComprobantePago obtenerComprobantePagoVigente(Long numeroLiquidacion,List<EstadoComprobantePago> estados) throws NoTieneComprobanteVigenteException;
	 ...
	 */
	ComprobantePagoPk generarComprobantePagoIndividual(List<Long> dividendos,DatosSituacionPrestamo datSituacionPrestamo)
			throws GenerarComprobantePagoIndividualExcepcion;

	/**
	 * Busca si un prestamo tiene generado algun comprobante de pago individual y esta vigente
	 * @param prestamoPk
	 * @return
	 */
	public Boolean existeComprobanteIndividualVigente(ValidarRequisitosComprobante valReqComprobante);
	
	public Boolean existeComprobantesIndividualesVigentes(ValidarRequisitosComprobante valReqComprobante);

	/**
	 * Devuelve la lista de comprbantes de pago individual vigentes para un prestamo
	 * @param prestamoPk
	 * @return
	 */
	public List<ComprobantePago> obtenerComprobanteIndividualVigente(ValidarRequisitosComprobante valReqComprobante);
	 ...
	 * @return
	 */
	public ComprobantePago obtenerPorPk(ComprobantePagoPk comprobantePagoPk) throws EntidadNoEncontradaException;
	...
	/**
	 * Permite generar el comprobante de liquidacion individual
	 * 
