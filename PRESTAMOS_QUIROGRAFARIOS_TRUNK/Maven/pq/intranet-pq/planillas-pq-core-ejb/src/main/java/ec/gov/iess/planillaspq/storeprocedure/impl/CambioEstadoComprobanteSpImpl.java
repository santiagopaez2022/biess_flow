...
import ec.gov.iess.planillaspq.storeprocedure.CambioEstadoComprobanteSpRemote;


@Stateless
public class CambioEstadoComprobanteSpImpl implements
CambioEstadoComprobanteSpLocal, CambioEstadoComprobanteSpRemote  {
	@Resource(mappedName = "java:/pqintranetDS")
	DataSource dataSource;
	String menerr;
	String coderr;
	public CambioEstadoComprobanteSpImpl() {
		super();
	}
	...
	private class EjecucionProcesoCambioEstado extends StoredProcedure {
		...
		private static final String SQL = "ksreckcompagesthis.actreghisestcompag";
