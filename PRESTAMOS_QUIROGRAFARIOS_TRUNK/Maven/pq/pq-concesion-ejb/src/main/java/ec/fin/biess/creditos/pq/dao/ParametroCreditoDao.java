...
public interface ParametroCreditoDao extends GenericDao<ParametroCredito, String> {

	/**
	 * Método que busca un parametro dado el código
	 * 
	 * @param codpol
	 * @return Parametro
	 */
