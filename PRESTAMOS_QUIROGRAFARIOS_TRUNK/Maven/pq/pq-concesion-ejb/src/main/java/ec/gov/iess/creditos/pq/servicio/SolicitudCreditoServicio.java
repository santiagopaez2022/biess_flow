...
public interface SolicitudCreditoServicio {
	 ...
	 * @param codEstSolSerList
	 * @return
	 * @throws IllegalArgumentException
	 */
	public boolean consultarSolicitudEnTramitePorCedulaEstadoTipoSolicitud(String cedula, List<Long> codTipSolSerList,
	 ...
	 * @throws IllegalArgumentException
	 */
	public boolean consultarSolicitudGastosAdministrativosPorCedulaTipoSolicitud(String cedula,
			List<Long> codTipSolSerList) throws IllegalArgumentException;
